...
<div class="row">
  <div class="col-sm-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <?php
          echo select_from('LevelDesc',"ac_m_LevelDescsAchStds WHERE Level = 'Year 7'");
        ?>
      </div>
    </div>
  </div>
  <div class="col-sm-6">
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <?php
          echo select_from('AchStd',"ac_m_LevelDescsAchStds WHERE Level = 'Year 7'");
        ?>
      </div>
    </div>
  </div>
...
foreach($s0 as $row0)
{
  ...
  foreach($s1 as $row1)
  {
    ...
    $s2->bindValue(':b',Config::read('app.hlevel.year7'),PDO::PARAM_STR);
    $s2->execute();
